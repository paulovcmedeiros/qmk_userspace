...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        LCTL_T(KC_BSLS),  XXXXXXX, KC_LGUI, KC_LSFT, LALT_T(KC_SPC),  LT(MOUSE, KC_SPC),  LT(NUMPAD, KC_SPC),       RSFT_T(KC_SPC), LT(SYMBOLS, KC_SPC), RALT_T(KC_SPC), KC_RSFT,     KC_MUTE,     XXXXXXX, RCTL_T(KC_ENT)
    ),
    // Layer 1: Mouse
    [MOUSE] = LAYOUT(
