...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUMPAD] = LAYOUT(
        ...
        UG_NEXT,     UG_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           KC_RSFT, KC_BSPC, KC_0, KC_RSFT,     XXXXXXX, XXXXXXX,         QK_LLCK
    ),
    // Layer 3: Symbols
    [SYMBOLS] = LAYOUT(
        ...
        XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,    KC_BSLS,    HOME_SLASH,  XXXXXXX,              XXXXXXX, XXXXXXX,    XXXXXXX,   XXXXXXX,     XXXXXXX,        XXXXXXX,  QK_LLCK
    )
};
// clang-format on
