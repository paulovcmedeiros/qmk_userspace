...
This repository is my personal QMK External Userspace, containing my custom
[QMK Firmware](https://docs.qmk.fm/) keymap for the
...
The userspace-root [watch-ergo68-keymap.py](watch-ergo68-keymap.py) is a small development helper for
...
[keymap_drawer_config.yaml](keymap_drawer_config.yaml) controls keymap-drawer's parsing, key labels, SVG
...
| File | Purpose |
| --- | --- |
| [keymap.c](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/keymap.c) | Layer definitions, layout, combos, normal RGB indicators, and QMK hook routing |
| [keymap.h](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/keymap.h) | Shared custom keycodes and behavior-module interfaces |
| [typing_macros.c](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/typing_macros.c) | Shebangs, slash/minus tap-hold, punctuation spacing, and modified-Space Backspace |
| [mouse_acceleration.c](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/mouse_acceleration.c) | Double-tap mouse acceleration |
| [key_lock.c](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/key_lock.c) | Pressing Key Lock again to release a locked key |
| [system_actions.c](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/system_actions.c) | Protected system actions, their RGB feedback, and split RPC synchronization |
| [config.h](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/config.h), [rules.mk](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/rules.mk) | QMK feature settings and module source registration |
| [keymap-documentation.json](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/keymap-documentation.json) | Layer names, combo labels, and behavior notes |
| [keymap_drawer_config.yaml](keymap_drawer_config.yaml) (userspace root) | Key labels and keymap-drawer parsing and SVG options |
| [keymap.svg](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/keymap.svg) | Generated diagram; regenerate and commit it |
| [keymap-combos.yaml](keyboards/yushakobo/ergo68/keymaps/paulovcmedeiros/keymap-combos.yaml) | Generated intermediate; never edit it |
